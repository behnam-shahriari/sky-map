...
import {
  calcConstellationLines,
  drawConstellationLines,
} from "./constellationLines.js";
import {
  calcConstellationLabels,
...
const VirtualSky = (props) => {
  ...
  const config = projectionsConfig(
    props.config.width,
    props.config.height,
  ...
  const draw = (svg, stars) => {
    ...
    if (
      visibility.showPlanets ||
      visibility.showPlanetsLabels ||
      visibility.showPlanetsOrbit
    ) {
