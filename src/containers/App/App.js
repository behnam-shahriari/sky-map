...
class App extends Component {
  constructor() {
    ...
    const token =
      "pk.eyJ1IjoiYmVobmFtLXNoYWhyaWFyaSIsImEiOiJjbDJianoxdWUwZzd1M2NzY3NiODJtdTd0In0.huxT56t4Mz3kWZoxTREDzQ";
    let ref = "";
  }
  ...
  render() {
    const { dedication, location, date, color, day, month, year, lat, lon } =
      this.state;
    return (
      <div className="main">
        <A4Page
        ...
        <div className="right">
          <InputForm
            ...
            dedication={dedication}
            onDedicationChange={this.onDedicationChange}
          />
          <br />
          <ReactToPrint
            trigger={() => {
